...
if(isset($_POST['inserir']) && $_POST['inserir'] == 'insere_editora')
{
    $nome = $_POST['nome'];
    $status = $_POST['status'];
    $observacao = $_POST['observacao'];

    $sql = "INSERT INTO editora (data_cadastro, status, nome, observacao ) VALUES ( NOW() ,$status,'$nome', '$observacao')";
                ...
                <div class="col-md-12">
                    <form action="" method="post">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="hidden" name="inserir" value="insere_editora">
