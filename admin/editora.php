        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover table-borded">
            <thead class="table-dark">
              <tr>
                ...
                <th colspan="2" scope="col" class="text-center">
                  <a href="editora_insere.php" class="btn btn-outline-light table-bordered btn-sm">
            ...
            <tbody>
              <?php do { ?>
              <tr>
                <td><?php echo $linha['codigo_editora'] ?></td>
                ...
                <td class="text-end">
                  <a href="editora_altera.php?codigo_editora=<?php echo $linha['codigo_editora'] ?>" class="btn btn-outline-warning btn-sm" title="Editar">
                    <i class="bi bi-pencil"></i>
                  </a>
                </td>
                <td class="text-start">
                  <a href="editora_exclui.php?codigo_editora=<?php echo $linha['codigo_editora'] ?>" class="btn btn-outline-danger btn-sm" title="Excluir">
